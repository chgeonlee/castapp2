...
export default class PinResource {
  private static _instance: PinResource;

  public static get instance() {
    return this._instance || (this._instance = new PinResource());
  }

  private constructor() {}

  public data: PinDataProps[] | null = null;
  ...
  async load(reload = false) {
    ...
    console.log("loaded");
    DeviceEventEmitter.emit(constants.event.LOADED_PIN_DATA, () => {});
  }

  addItem = (item: PinDataProps) => {
    if (this.data == null) {
      return;
    }
